...
let handler = async (m, { conn, groupMetadata }) => {
  ...
  if (participantes.length < 4) {
    return m.reply('😎 *RICKI BOT* 😎\n\nEy... me faltan personas pa armar el ship 👀\nNecesito mínimo 4 en el grupo para lanzar 2 parejitas 💘')
  }
  ...
  // Armar el mensaje
  let texto = `😎 *RICKI BOT - CUPIDO RANDOM* 😎\n\n`
  texto += `✨ *Activando modo chismecito y amor* ✨\n\n`
  ...
  texto += `⚡ Diseñado con flow y buena vibra por *Ricki Bot* ⚡`
